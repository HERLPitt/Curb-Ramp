...
import com.josh.cs_4401app.adapter.NavDrawerListAdapter;
...
public class Main extends FragmentActivity {
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            case 0:
                fragment = new InfoGeneralFragment();
                break;
            case 1:
                fragment = new ConstructionInfoFragment();
                break;
            case 2:
                fragment = new RampTypeChooserFragment();
                break;
            case 3:
                fragment = new PushButtonSelection();
                break;
            case 4:
